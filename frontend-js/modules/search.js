  ...
  renderResultsHTML(posts) {
    if (posts.length) {
      ...
      ${posts
        ...
        } on ${postDate.getDate()}/${postDate.getMonth() +
      ...
      this.resultsArea.innerHTML = `<p class='alert text-center alert-info shadow.sm'>No results .</p>`
    }
  ...
  injectHTML() {
    ...
    <div class="search-overlay-top shadow-sm">
      <div class="container container--narrow">
        ...
        <input type="text" id="live-search-field" class="live-search-field" placeholder="Search...">
